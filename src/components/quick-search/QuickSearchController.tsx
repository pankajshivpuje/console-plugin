        ...
        (acc, quickSearchProvider) => {
          ...
          const viewAllLink =
            itemCount > 0 && isLimitedList
              ? [
                  {
                    label: t(quickSearchProvider.catalogLinkLabel, {
                      itemCount,
                    }),
                    to: quickSearchProvider.getCatalogURL(
                      searchTerm,
                      namespace,
                    ),
              ...
              : [];
          const catalogItemTypes = quickSearchProvider.extensions.map(
            (extension) => ({
          ...
          return {
            filteredItems: [...acc.filteredItems, ...items].sort(
